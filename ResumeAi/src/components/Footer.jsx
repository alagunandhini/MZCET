const Footer = () => {
    return (
      <>
        <div className="bg-sky-300/20 py-10">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {/* Logo and Name */}
            <div className="flex flex-col items-start gap-3">
               
                <div className=" flex gap-2 justify-center items-center">
                <img src="completed logo.png" alt="Logo" className="h-12 w-12 object-contain" />
                <h1 className="font-bold text-xl text-gray-700">Mz Mock Ai</h1>
                </div>
